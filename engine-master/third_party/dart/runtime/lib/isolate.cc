...
class SpawnIsolateTask : public ThreadPool::Task {
 public:
  ...
  void Run() override {
    ...
    // create_group_callback对应[->third_party/dart/runtime/bin/main.cc]中的CreateIsolateGroupAndSetup函数
    // CreateIsolateGroupAndSetup是在Dart VM初始化时设置的
    ...
    //在AOT编译环境下，FLAG_enable_isolate_groups为true，否则为false
